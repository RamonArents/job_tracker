<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Je kan je sessies uitloggen op alle andere browsers en devices.') }}
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Soms is het nodig alle andere sessies uit te loggen. Als je denkt dat je account gehackt is wijzig dan ook je wachtwoord.') }}
        </div>
        ...
        <div class="flex items-center mt-5">
            <x-jet-button wire:click="confirmLogout" wire:loading.attr="disabled">
                {{ __('Log Andere Browser Sessies Uit') }}
            </x-jet-button>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Vul je wachtwoord in om te bevestigen.') }}
